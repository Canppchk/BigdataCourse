...
public class maxPrice {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = new Job(c, "max price");
        job.setJarByClass(maxPrice.class);
        job.setMapperClass(MapFormax.class);
        job.setReducerClass(ReduceFormax.class);
    ...
    public static class MapFormax extends Mapper<LongWritable, Text, Text, FloatWritable> {
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            Text outputKey = new Text("max price");
            FloatWritable outputValue = new FloatWritable(Float.parseFloat(str[3].trim()));
